...
Route::controller(PostController::class)->middleware(['auth'])->group(function(){
    ...
    Route::delete('/posts/{post}/quit', 'quit')->name('quit');
...
Route::controller(EventController::class)->middleware(['auth'])->group(function(){
    Route::post('/posts/{post}/add', 'add')->name('add');
    Route::post('/posts/{post}', 'participate')->name('participate');
    Route::get('/posts/{post}/api/get-users-count-by-day', 'getUsersCountByDay')->name('getUsersCountByDay');
    Route::get('/posts/{post}/members', 'viewEventMembers')->name('viewEventMembers');
    Route::delete('/posts/{post}/cancel', 'cancelEvent')->name('cancelEvent');
